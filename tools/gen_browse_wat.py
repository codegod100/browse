#!/usr/bin/env python3
"""Generate gleam/browse/prebuilt/browse.wat from declarative screens/labels."""
...
OUT_WAT = ROOT / "gleam/browse/prebuilt/browse.wat"
OUT_WASM = ROOT / "gleam/browse/prebuilt/browse.wasm"
...
def main() -> None:
    ...
    lines.append(";; Mirrors gleam/browse/src/browse.gleam TEA + labels + view_text.")
    lines.append("(module")
